    ...
    <DashboardLayout>
      <div className="space-y-6" data-testid="ai-assistant-page">
        <div>
          ...
          <p className="text-muted-foreground">Your Operational AI Engine — Intelligent workforce automation</p>
        </div>
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Enterprise operational AI for workforce automation</p>
                  </div>
                  <div className="text-sm text-muted-foreground mt-4 space-y-1">
                    <p>• Automated task analysis & breakdown</p>
                    <p>• Workforce analytics & reports</p>
                    <p>• Policy automation & compliance</p>
                  </div>
                </div>
              </div>
            ) : (
          ...
          <div className="border-t border-border p-4 bg-card">
            <form onSubmit={handleSubmit} className="flex gap-2">
              <Textarea
                ...
                placeholder="Ask OperAI Intelligence..."
              ...
              />
              <Button type="submit" size="icon" className="h-[60px] w-[60px] bg-primary text-primary-foreground hover:bg-primary/90" disabled={loading || !input.trim()} data-testid="chat-send-btn">
